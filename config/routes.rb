...
match '/access_tickets/expand_by_user', :controller => 'iaccesses', :action => 'expand_by_user', :via => :get

match '/access_tickets/expand_by_resource', :controller => 'iaccesses', :action => 'expand_by_resource', :via => :get
...
match '/access_tickets/accesses_list/export_accesses', :controller => 'iaccesses', :action => 'export_accesses', :via => :post
...
match '/access_tickets/show_group_details', :controller => 'isettings', :action => 'show_group_details', :via => :post

match '/access_tickets/set_group_liders', :controller => 'isettings', :action => 'set_group_liders', :via => :post

match '/access_tickets/edit_revoking_table', :controller => 'iaccesses', :action => 'edit_revoking_table', :via => :post

match '/access_tickets/edit_revoking_table/save', :controller => 'iaccesses', :action => 'save_revoking_table', :via => :post

match '/access_tickets/show_last_users', :controller => 'itickets', :action => 'show_last_users', :via => :post

match '/access_tickets/edit_ticket_table', :controller => 'itickets', :action => 'edit_ticket_table', :via => :post

match '/issues/access_tickets/edit_ticket_table_ta', :controller => 'itickets', :action => 'edit_ticket_table_ta', :via => :post

match '/access_tickets/edit_ticket_table/save_ta', :controller => 'itickets', :action => 'edit_ticket_table_save_ta', :via => :post

match '/access_tickets/edit_retiming_table', :controller => 'iretimeaccesses', :action => 'edit_retiming_table', :via => :post

match '/access_tickets/edit_retiming_table/save', :controller => 'iretimeaccesses', :action => 'save_retiming_table', :via => :post

match '/access_tickets/verify_retiming', :controller => 'iretimeaccesses', :action => 'verify_retiming', :via => :get

match '/access_tickets/reject_retiming', :controller => 'iretimeaccesses', :action => 'reject_retiming', :via => :get

match '/access_tickets/approve_retiming', :controller => 'iretimeaccesses', :action => 'approve_retiming', :via => :get

match '/access_tickets/revoke_retiming', :controller => 'iretimeaccesses', :action => 'revoke_retiming', :via => :get

match '/access_tickets/verify_template', :controller => 'iticktemplates', :action => 'verify_template', :via => :get

match '/access_tickets/reject_template', :controller => 'iticktemplates', :action => 'reject_template', :via => :get

match '/access_tickets/approve_template', :controller => 'iticktemplates', :action => 'approve_template', :via => :get

match '/access_tickets/revoke_template', :controller => 'iticktemplates', :action => 'revoke_template', :via => :get
...
match '/access_tickets/edit_ticket_table/save', :controller => 'itickets', :action => 'edit_ticket_table_save', :via => :post

match '/access_tickets/edit_ticket_table/show', :controller => 'itickets', :action => 'ticket_table_show', :via => :post

match '/access_tickets/edit_ticket_table/show_version', :controller => 'itickets', :action => 'ticket_table_show_version', :via => :post

match '/access_tickets/edit_ticket_table/set_tickets_user', :controller => 'itickets', :action => 'set_tickets_user', :via => :get

match '/access_tickets/approve_tickets', :controller => 'itickets', :action => 'approve_tickets', :via => :get

match '/access_tickets/revoke_tickets', :controller => 'itickets', :action => 'revoke_tickets', :via => :get

match '/access_tickets/verify_tickets', :controller => 'itickets', :action => 'verify_tickets', :via => [:get, :post]

match '/access_tickets/reject_tickets', :controller => 'itickets', :action => 'reject_tickets', :via => [:get, :post]
...
match '/access_tickets/show_group_templates', :controller => 'iticktemplates', :action => 'show_group_templates', :via => :post

match '/access_tickets/show_template_versions', :controller => 'iticktemplates', :action => 'show_template_versions', :via => :post

match '/access_tickets/set_dismissal_user', :controller => 'iaccesses', :action => 'set_dismissal_user', :via => :get

match '/access_tickets/grant_access', :controller => 'iaccesses', :action => 'grant_access', :via => :get

match '/access_tickets/revoke_grant', :controller => 'iaccesses', :action => 'revoke_grant', :via => :get

match '/access_tickets/grant_single_access', :controller => 'iaccesses', :action => 'grant_single_access', :via => :post

match '/access_tickets/revoke_single_grant', :controller => 'iaccesses', :action => 'revoke_single_grant', :via => :post

match '/access_tickets/confirm_access', :controller => 'iaccesses', :action => 'confirm_access', :via => :get

match '/access_tickets/revoke_confirmation', :controller => 'iaccesses', :action => 'revoke_confirmation', :via => :get

match '/access_tickets/confirm_revoking', :controller => 'iaccesses', :action => 'confirm_revoking', :via => :get

match '/access_tickets/refuse_confirmation_revoking', :controller => 'iaccesses', :action => 'refuse_confirmation_revoking', :via => :get

match '/access_tickets/deactivate_grants', :controller => 'iaccesses', :action => 'deactivate_grants', :via => :get

match '/access_tickets/refuse_deactivating_grants', :controller => 'iaccesses', :action => 'refuse_deactivating_grants', :via => :get

match '/access_tickets/deactivate_single_grant', :controller => 'iaccesses', :action => 'deactivate_grants', :via => :post

match '/access_tickets/activate_single_grant', :controller => 'iaccesses', :action => 'refuse_deactivating_grants', :via => :post

match '/access_tickets/show_retiming_accesses', :controller => 'iretimeaccesses', :action => 'show_retiming_accesses', :via => :post
